...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d6fc57df-1b8b-4db1-8c9d-e6cc12cafa41
```

> `d6fc57df-1b8b-4db1-8c9d-e6cc12cafa41` is the password of the certificate, you can change it to any password you want.
